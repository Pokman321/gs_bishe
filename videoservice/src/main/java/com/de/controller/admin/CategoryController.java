...
public class CategoryController {
    ...
    public String categoryPage(HttpServletRequest request) {
        System.out.println("进去categories了");
    ...
    public MyResult list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(categoryService.getCameraCategoryPage(pageUtil));
    }
    ...
    @ResponseBody
    public MyResult save(@RequestParam("categoryName") String categoryName,
    ...
    @ResponseBody
    public MyResult update(@RequestParam("categoryId") Integer categoryId,
