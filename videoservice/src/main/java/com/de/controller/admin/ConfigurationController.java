...
public class ConfigurationController {
    ...
    @ResponseBody
    public MyResult website(@RequestParam(value = "websiteName", required = false) String websiteName,
    ...
    @ResponseBody
    public MyResult userInfo(@RequestParam(value = "yourAvatar", required = false) String yourAvatar,
    ...
    @ResponseBody
    public MyResult footer(@RequestParam(value = "footerAbout", required = false) String footerAbout,
