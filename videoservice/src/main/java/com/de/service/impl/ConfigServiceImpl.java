...
import com.de.dao.CameraConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "personal camera";
    public static final String websiteDescription = "personal camera是SpringBoot2+Thymeleaf+Mybatis建造的个人博客网站.SpringBoot实战博客源码.个人博客搭建";
    ...
    public static final String footerAbout = "your personal camera. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2018 十三";
    public static final String footerPoweredBy = "personal camera";
    public static final String footerPoweredByURL = "##";

    @Override
    public int updateConfig(String configName, String configValue) {
        CameraConfig cameraConfig = configMapper.selectByPrimaryKey(configName);
        if (cameraConfig != null) {
            cameraConfig.setConfigValue(configValue);
            cameraConfig.setUpdateTime(new Date());
            return configMapper.updateByPrimaryKeySelective(cameraConfig);
        }
        return 0;
    }
    ...
    public Map<String, String> getAllConfigs() {
        //获取所有的map并封装为map
        List<CameraConfig> cameraConfigs = configMapper.selectAll();
        Map<String, String> configMap = cameraConfigs.stream().collect(Collectors.toMap(CameraConfig::getConfigName, CameraConfig::getConfigValue));
